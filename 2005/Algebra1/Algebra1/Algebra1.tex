...
% pdf infos
\hypersetup{
  pdftitle={Mitschrift zu Algebra 1 von Prof. Herrlich},
  pdfauthor={Timo Bingmann},
  pdfsubject={Algebra 1},
  pdfkeywords={Algebra},
...
\newtheoremstyle{mybreak}%
  {\medskip\item[\rlap{\vbox{\hbox{\hskip\labelsep \normalfont\bfseries
       	##1\ ##2}\hbox{\strut\vspace{3pt}}}}]}%
  {\medskip\item[\rlap{\vbox{\hbox{\hskip\labelsep \normalfont\bfseries
	##1\ ##2\ (##3)}\hbox{\strut\vspace{3pt}}}}]}
...
%opening
\title{Mitschrift zu Algebra 1 von Prof. Herrlich}
