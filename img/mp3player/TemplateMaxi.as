...
class TemplateMaxi extends ATemplate
{
    ...
    private var _backgroundColor1:Number = 0xb0b0b0;
    private var _backgroundColor2:Number = 0x404040;
    private var _buttonColor:Number = 0xffffff;
    private var _buttonOverColor:Number = 0x0020ff;
    private var _sliderColor1:Number = 0xcccccc;
    private var _sliderColor2:Number = 0xaaaaaa;
    private var _sliderOverColor:Number = 0x0020ff;
    private var _textColor:Number = 0xffffff;
    private var _loadingColor:Number = 0x0050ff;
    ...
    private var _showLoading:String = "always"; // always, autohide, never
...
[0,255], 
	...
	this._playButtonInstance.icon_mc.lineTo(0, 10);
	this._playButtonInstance.icon_mc.lineTo(8, 5);
